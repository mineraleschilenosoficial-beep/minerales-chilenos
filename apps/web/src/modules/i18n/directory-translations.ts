...
export const directoryTranslations: Record<SupportedLocale, DirectoryTranslation> = {
  ...
  es: {
    ...
    landingNavCategories: "Categorías",
    ...
    landingPricingSubtitle: "Elige el plan que más se adapte a tu empresa. Primer mes gratis en planes pagados.",
    landingPlanBasicName: "Básico",
    landingPlanStandardName: "Estándar",
    landingPlanPremiumName: "Premium",
    landingPlanBasicPrice: "$0",
    landingPlanStandardPrice: "$19.990",
    landingPlanPremiumPrice: "$49.990",
    ...
    landingPlanPopularBadge: "Más popular",
    landingPlanBasicFeatures: [
      "Nombre de empresa",
      "Categoría y ciudad",
      "Descripción corta",
    ...
    landingCtaTitle: "¿Tu empresa aún no está?",
    landingCtaSubtitle: "Regístrala hoy y publícala en menos de 24 horas.",
    ...
    heroSubtitle:
      "Busca empresas por categoría, compara perfiles de proveedores y envía tu empresa para publicación en el directorio.",
    ...
    paginationPageOf: "Página",
    operationsTitle: "Operación de solicitudes",
    operationsSubtitle: "Revisa y procesa solicitudes de publicación de proveedores.",
    ...
    operationsCanonicalReadyCountLabel: "Canónicas en lista",
    operationsCanonicalPendingCountLabel: "Pendientes en lista",
    operationsSortLabel: "Orden por fecha",
    operationsSortNewest: "Más nuevas primero",
    operationsSortOldest: "Más antiguas primero",
    operationsSearchPlaceholder: "Buscar por empresa, correo o teléfono",
    operationsPaginationPage: "Página",
    ...
    operationsAuthSubtitle: "Autentícate para revisar y gestionar solicitudes.",
    operationsAuthEmailLabel: "Correo",
    operationsAuthPasswordLabel: "Contraseña",
    operationsAuthLoginAction: "Ingresar",
    operationsAuthLogoutAction: "Salir",
    operationsAuthLoginError: "Credenciales inválidas o usuario inactivo.",
    operationsAuthSessionExpired: "Tu sesión expiró. Ingresa nuevamente.",
    ...
    operationsDashboardStandardCompanies: "Empresas estándar",
    ...
    operationsCompaniesTitle: "Gestión de Empresas",
    ...
    operationsPlansPremium: "Premium",
    operationsPlansStandard: "Estándar",
    ...
    operationsUsersTitle: "Administración de Usuarios",
    ...
    operationsUsersLoadError: "No se pudo cargar la administración de usuarios.",
    operationsUsersCreateTitle: "Crear usuario",
    operationsUsersNameLabel: "Nombre completo",
    operationsUsersEmailLabel: "Correo",
    operationsUsersPasswordLabel: "Contraseña temporal",
    operationsUsersRolesLabel: "Roles",
    ...
    operationsNotesLabel: "Notas de revisión",
    operationsApplyAction: "Aplicar revisión",
    operationsApplyingAction: "Aplicando...",
    operationsSuccessFeedback: "Revision aplicada correctamente.",
    operationsErrorFeedback: "No se pudo aplicar la revisión. Inténtalo nuevamente.",
    operationsStatusPending: "Pendiente",
    operationsStatusUnderReview: "En revisión",
    operationsStatusApproved: "Aprobada",
    operationsStatusRejected: "Rechazada",
    operationsStatusOptionUnderReview: "Marcar en revisión",
    ...
    operationsLatestReviewNotesLabel: "Últimas notas de revisión",
    operationsNoReviewNotes: "Sin notas de revisión.",
    operationsRequestedLocationLabel: "Ubicacion solicitada",
    operationsCanonicalLocationLabel: "Ubicación canónica",
    operationsCanonicalLocationPending: "Aún no seleccionada.",
    operationsLocationMatchLabel: "Canónica coincide",
    operationsLocationMismatchLabel: "Canónica distinta",
    operationsShowReviewPanelAction: "Ver revisión",
    operationsHideReviewPanelAction: "Ocultar revisión",
    ...
    noSupplierResults: "No hay proveedores que coincidan con tu búsqueda.",
    viewDetailsAction: "Ver detalle",
    requestTitle: "Publica Tu Empresa",
    formNameLabel: "Nombre de empresa",
    formTaglineLabel: "Descripción corta",
    formDescriptionLabel: "Descripción",
    formCityLabel: "Ciudad",
    formRegionLabel: "Región",
    formCountryLabel: "País",
    formRegionSelectPlaceholder: "Selecciona región",
    ...
    invalidFormFeedback: "Completa el formulario con valores válidos.",
    formErrorRequired: "Este campo es obligatorio.",
    formErrorInvalidEmail: "Ingresa un correo válido.",
    ...
    formErrorMaxChars2000: "Debe tener máximo 2000 caracteres.",
    ...
    submitErrorFeedback: "No se pudo enviar la solicitud. Inténtalo nuevamente.",
    categories: {
      [CompanyCategory.LABORATORY]: "Laboratorio",
      [CompanyCategory.CONSULTING]: "Consultoría",
      ...
      [CompanyCategory.SOFTWARE]: "Software",
      [CompanyCategory.ENGINEERING]: "Ingeniería"
    },
    plans: {
      [CompanyPlan.FREE]: "Gratis",
      [CompanyPlan.STANDARD]: "Estándar",
      [CompanyPlan.PREMIUM]: "Premium"
    }
  }
};
